...
with open(path.join(CURRENT_DIR, 'cidades-estados-brasil-json', 'Estados.json'), 'r') as f:
    ESTADOS_JSON = load(f)

with open(path.join(CURRENT_DIR, 'cidades-estados-brasil-json', 'Cidades.json'), 'r') as f:
    CIDADES_JSON = load(f)
